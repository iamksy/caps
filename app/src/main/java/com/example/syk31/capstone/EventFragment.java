...
public class EventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String user_area = pref.getString("sharedID","");

        String userArea = user_area.toString();
        ...
        try {
            task.execute("http://irmin95.cafe24.com/EventList6.php?userArea=" + URLEncoder.encode(userArea,"UTF-8"));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                String num = c.optString(TAG_NUM);
                String id = c.optString(TAG_AREA);
...
//                list.put(TAG_IMG, img);
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    new String[]{TAG_AREA, TAG_TITLE, TAG_CONTENT, TAG_START, TAG_CLOSE},
